...
Currently, there is no way of updating the visibility property in the component's state.
 ...
 on the button which triggers a class method called toggleVisibility(). Define this
  method so the state of visibility toggles to the opposite value when the method is called. 
